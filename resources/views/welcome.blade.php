                        ...
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="10.5″-iPad-Pro-Copy-6" transform="translate(-116.000000, -134.000000)">
                                <g id="Group-3" transform="translate(115.000000, 136.000000)">
                                    ...
                                    <g id="Jelly" style="transform: translateY(-1.89614%);">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('multi_input') }}" class="text-gray-900 dark:text-white">Dynamic Multi Input</a></div>
                            </div>
                        </div>
